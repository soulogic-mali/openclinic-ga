...
public class ItemVO implements Serializable, IIdentifiable, Comparable {
    ...
    public static ItemVO fromXMLElement(Element item) {
    	ItemVO itemVO = null;
    	try {
			itemVO = new ItemVO(Integer.parseInt(item.elementText("ItemId")),item.elementText("ItemType"),item.elementText("ItemValue"),ScreenHelper.fullDateFormatSS.parse(item.elementText("ItemDate")),null);
		} catch (Exception e) {
