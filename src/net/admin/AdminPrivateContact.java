...
public class AdminPrivateContact{
    ...
    private boolean updatePrivate(String sPrivateID, Connection connection){
        ...
        hSelect.put(" address = ? ",SH.c(this.address));
        hSelect.put(" city = ? ",SH.c(this.city));
        hSelect.put(" zipcode = ? ",SH.c(this.zipcode));
        hSelect.put(" country = ? ",SH.c(this.country));
        hSelect.put(" telephone = ? ",SH.c(this.telephone));
        hSelect.put(" fax = ? ",SH.c(this.fax));
        hSelect.put(" mobile = ? ",SH.c(this.mobile));
        hSelect.put(" email = ? ",SH.c(this.email));
        hSelect.put(" comment = ? ",SH.c(this.comment));
        hSelect.put(" type = ? ",SH.c(this.type));
        hSelect.put(" district = ? ",SH.c(this.district));
        hSelect.put(" sanitarydistrict = ? ",SH.c(this.sanitarydistrict));
        hSelect.put(" province = ? ",SH.c(this.province));
        hSelect.put(" sector = ? ",SH.c(this.sector));
        hSelect.put(" cell = ? ",SH.c(this.cell));
        hSelect.put(" quarter = ? ",SH.c(this.quarter));
        hSelect.put(" businessfunction = ? ",SH.c(this.businessfunction));
        hSelect.put(" business = ? ",SH.c(this.business));
