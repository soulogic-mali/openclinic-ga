...
<%
	if(!activeUser.getParameter("DefaultPage").equalsIgnoreCase("maintenance") || SH.c(request.getParameter("forcePatientHeader")).equalsIgnoreCase("1") || SH.c(request.getParameter("PersonID")).length()>0){
