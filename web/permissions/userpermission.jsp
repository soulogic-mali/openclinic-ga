...
<%
    ...
    */
    ...
    while(iter.hasNext()){
        ...
        if(sSearchProject.length()==0 || sTmpProject.equalsIgnoreCase(sSearchProject) || sTmpProject.equalsIgnoreCase(sProjectAccessAllSites)){
    ...
    if(sAction.equals("save")){
        ...
        for(int i=0; i<thisUser.parameters.size(); i++){
            ...
            if(parameter.parameter.equalsIgnoreCase("mailuser")
                ...
                || parameter.parameter.equalsIgnoreCase("finalauthor")
                || parameter.parameter.equalsIgnoreCase("finalclinicaldata")
    ...
    %>
        <form name="transactionForm" id="transactionForm" method="post">
            ...
            <table width='100%' class="menu" cellspacing="1" cellpadding="0">
                ...
                <%=writeMyCheckbox(getTran(request,"web","finalAuthor",sWebLanguage),"EditFinalAuthor","finalauthor",thisUser)%>
                <%=writeMyCheckbox(getTran(request,"web","clinicaldatanotmodifiable",sWebLanguage),"EditFinalClinicalData","finalclinicaldata",thisUser)%>
