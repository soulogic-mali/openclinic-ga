...
<%
	String accessright="mspls.registry.childrencare";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO) transaction, "ITEM_TYPE_WEIGHT", 5, 1, 150, sWebLanguage) %> kg
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"web", "height", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO) transaction, "ITEM_TYPE_HEIGHT", 8, 20, 220, sWebLanguage) %> cm
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"web", "dangersigns", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.cds.dangersigns", "ITEM_TYPE_DANGERSIGNS", sWebLanguage, true) %>
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"web", "clinicalexamination", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.cds.clinicalexam", "ITEM_TYPE_CLINICALEXAMINATION", sWebLanguage, true) %>
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"web", "othersymptoms", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_OTHERSYMPTOMS", 60,2) %>
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"mspls", "vaccinationsok", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_VACCINATIONSOK", sWebLanguage, true, "", " ") %>
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"mspls", "vitaminaok", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_VITAMINAOK", sWebLanguage, true, "", " ") %>
            </td>
        </tr>
        <tr>
            ...
            <td class="admin2">
				<table width='100%'>
					<tr>
						...
						<td width='20%'><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_URINE","mspls.labresult", sWebLanguage, "") %> <%=getTran(request,"web","urine",sWebLanguage) %> </td>
						<td width='20%'><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HB","mspls.labresult", sWebLanguage, "") %> <%=getTran(request,"web","hemoglobine",sWebLanguage) %> </td>
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_NUTRITIONINFORMATION", sWebLanguage, true, "", " ") %>
            </td>
        </tr>
        <tr>
