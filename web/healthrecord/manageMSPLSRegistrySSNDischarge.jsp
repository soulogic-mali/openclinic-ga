...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_DISCHARGETYPE", "mspls.ssn.dischargetype", sWebLanguage, "") %>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=SH.writeDefaultCheckBox((TransactionVO)transaction, request, "medwan.common.true", "ITEM_TYPE_KIT_DISTRIBUTED", "") %><%=getTran(request,"web","yes",sWebLanguage) %>&nbsp;
