...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr class='admin'><td colspan='4'><%=getTran(request,"web","admission",sWebLanguage) %></td></tr>
		<tr>
		...
		<tr>
		   	...
		   	<td class='admin2' colspan='3'><%=SH.writeDefaultTextArea(session, (TransactionVO)transaction, "ITEM_TYPE_CREN_COMPLICATION", 50,1) %></td>
		</tr>
