...
<table class="list" width="100%" cellspacing="1" cellpadding="1">
    <tr class="admin2">
    	...
    	<td width="50%" style="vertical-align:top;">
			...
			<table class="list" width="100%" cellspacing="1">
			    <tr class="admin">
			        <td align="center"><a href="javascript:openPopup('healthrecord/findICPC.jsp&AuthorUID='+(document.getElementById('diagnosisUser')?document.getElementById('diagnosisUser').value:'')+'&ts=<%=getTs()%>&patientuid=<%=activePatient.personid %>',700,400);void(0);"><%=getTran(request,"openclinic.chuk","diagnostic.document",sWebLanguage)%> <%=getTran(request,"Web.Occup","ICPC-2",sWebLanguage)%>/<%=getTran(request,"Web.Occup","ICD-10",sWebLanguage)%></a></td>
			    </tr>
			    <tr>
			        <td id='icpccodes'>
