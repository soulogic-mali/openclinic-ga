    ...
    <table class="list" width="100%" cellspacing="1">
	    		...
	    		<table width="100%">
	    			<tr>
						...
						<td width='*'>
							...
							<select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_16_VA_RE" property="itemId"/>]>.value">
							<option/>
							<%=ScreenHelper.writeSelect(request,"ccbrt.va.lr",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_16_VA_RE"),sWebLanguage,false,true) %>
							</select>
						</td>
	    			</tr>
	    			<tr>
						...
						<td width='*'>
							<%=getTran(request,"web","cdo.VA",sWebLanguage)%>
							<select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_16_VA_LE" property="itemId"/>]>.value">
							<option/>
							<%=ScreenHelper.writeSelect(request,"ccbrt.va.lr",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_16_VA_LE"),sWebLanguage,false,true) %>
							</select>
						</td>
	    			</tr>
	    			<tr>
						...
						<td width='*'>
							<%=getTran(request,"web","cdo.VA",sWebLanguage)%>
							<select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_16_ADD_VA" property="itemId"/>]>.value">
							<option/>
							<%=ScreenHelper.writeSelect(request,"ccbrt.va.lr",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_16_ADD_VA"),sWebLanguage,false,true) %>
							</select>
						</td>
	    				<td/>
	    			</tr>
	    			<tr>
						...
						<td width='*'>
							<%=getTran(request,"web","cdo.VA",sWebLanguage)%>
							<select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_17_VA_RE" property="itemId"/>]>.value">
							<option/>
							<%=ScreenHelper.writeSelect(request,"ccbrt.va.lr",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_17_VA_RE"),sWebLanguage,false,true) %>
							</select>
						</td>
	    			</tr>
	    			<tr>
	    				<td class="admin2"></td>
	    				<td class="admin" width='10%'><%=getTran(request,"web","cdo.LE",sWebLanguage)%></td>
						...
						<td width='*'>
							<%=getTran(request,"web","cdo.VA",sWebLanguage)%>
							<select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_17_VA_LE" property="itemId"/>]>.value">
							<option/>
							<%=ScreenHelper.writeSelect(request,"ccbrt.va.lr",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_17_VA_LE"),sWebLanguage,false,true) %>
							</select>
						</td>
	    			</tr>
	    			<tr>
	    				<td class="admin2" colspan="1"></td>
	    				<td class="admin2" style='text-align: center' colspan="2">
	    					<%=getTran(request,"web","cdo.addplus.L",sWebLanguage)%>
						...
						<td width='*'>
							<%=getTran(request,"web","cdo.VA",sWebLanguage)%>
							<select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_17_ADD_VA" property="itemId"/>]>.value">
							<option/>
							<%=ScreenHelper.writeSelect(request,"ccbrt.va.lr",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_17_ADD_VA"),sWebLanguage,false,true) %>
							</select>
						</td>
		...
		<tr>
	    	<td class="admin2" colspan="2" style="padding: 0px">
	    		<table width='100%'>
	    			<tr>
				        <td class="admin" width='39%'><%=getTran(request,"web","cdo.remarks",sWebLanguage)%></td>
				        <td class="admin2">
				            <textarea  onKeyup="this.value=this.value.toUpperCase();resizeTextarea(this,10);" class="text" cols="40" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_REMARKS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_REMARKS" translate="false" property="value"/></textarea>
				        </td>
				    </tr>
	    		</table>
	    	</td>
	    	<td class="admin2" colspan="4" style="padding: 0px; vertical-align: top">
	    		<table width='100%'>
				    <tr>
				        <td class="admin"><%=getTran(request,"web","cdo.disability",sWebLanguage)%></td>
						<td class="admin2" nowrap colspan="3">
							<select id='disability' class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_DISABILITY" property="itemId"/>]>.value" >
							<option></option>
							<%=ScreenHelper.writeSelectUpperCase("cdo.disability",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_DISABILITY"),sWebLanguage,false,false)%>
							</select>
						</td>
	    			</tr>
	    		</table>
	    ...
	    <tr>
			...
			<td class="admin" colspan="4" style="padding: 0px; vertical-align: top">
	        	<table width="100%">
					<tr> <td class="admin" colspan="1" ><%=getTran(request,"web","cdo.todays.intake",sWebLanguage)%></td></tr>
	        		<tr>
