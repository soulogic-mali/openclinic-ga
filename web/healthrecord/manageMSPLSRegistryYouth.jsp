...
<%
	String accessright="mspls.registry.youth";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            <td class="admin"><%=getTran(request,"mspls", "advice", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.youth.advice",  "ITEM_TYPE_ADVICE", sWebLanguage, true) %>
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"mspls", "vaccination", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.youth.vaccination",  "ITEM_TYPE_VACCINATION", sWebLanguage, true) %>
            </td>
        </tr>
        <tr>
