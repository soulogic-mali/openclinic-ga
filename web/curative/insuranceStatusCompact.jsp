...
<table class="list" width="100%" cellspacing="0">
    <tr class="admin">
        <td>
            ...
            <a href="<c:url value='/main.jsp'/>?Page=financial/insurance/editInsuranceCompact.jsp&ts=<%=getTs()%>"><img height='16px' style='vertical-align: middle' src="<c:url value='/_img/icons/icon_newpage.png'/>" class="link" title="<%=getTranNoLink("web","newinsurance",sWebLanguage)%>" style="vertical-align:-4px;"></a>
	        ...
	        <%}
              if(MedwanQuery.getInstance().getConfigInt("enableSIS",0)==1 && Insurance.getActiveInsurance(activePatient.personid, MedwanQuery.getInstance().getConfigString("SIS","1.29"))==null){
            	%>
