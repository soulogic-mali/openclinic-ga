    ...
    if (request.getParameter("submit") != null) {
        ...
        try {
            ...
            while (tables.hasNext()) {
				...
				//Check if table is compatible with database server
				if(ScreenHelper.checkString(table.attributeValue("server")).length()>0 && !sLocalDbType.equalsIgnoreCase(table.attributeValue("server"))){
					continue;
				}
