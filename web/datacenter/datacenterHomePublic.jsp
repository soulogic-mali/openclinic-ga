                ...
                <div id="footer">
                    <div id="footer_logo">
                        <%
                            if(session.getAttribute("datacenteruser")!=null){
                        %>
                            <img height="40px;" src="<%=MedwanQuery.getInstance().getConfigString("datacenterUserLogo."+session.getAttribute("datacenteruser"),MedwanQuery.getInstance().getConfigString("datacenterUserLogo",sCONTEXTPATH+"/_img/world.png"))%>"/>
                        <%
                            }
                        %>
