...
<table width='100%'>
	...
	<tr>
		...
		<td class='mobileadmin2' style='font-size:4vw;'>
	       	<select name='nomenclature' id='nomenclature' style='width: 95% !important;font-size: 4vw;height: 6vw;'>
	       		...
	       		<%
	       			PreparedStatement ps = conn.prepareStatement("select * from oc_labels where oc_label_type='admin.nomenclature.asset' and oc_label_language=? and oc_label_id like 'e%' order by oc_label_id");
	...
	<tr>
		...
		<td class='mobileadmin2' style='font-size:4vw;'>
            ...
            <input type='hidden' name='comment9' id='comment9'/>
		</td>
	</tr>
	<tr>
		<td class='mobileadmin' style='font-size:4vw;'>
